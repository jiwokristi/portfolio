    ...
    <section className="flex min-h-[80vh] items-center py-24">
      <Container>
        <div className="max-w-3xl space-y-6">
          <p className="text-sm font-medium uppercase tracking-widest text-accent">Developer &amp; Designer</p>
          ...
          <p className="max-w-lg text-lg text-text-secondary leading-relaxed">
            I design and build high-performance websites and applications with a focus on user experience,
